                        ...
                        <div class="gallery">
                            ...
                            <div class="xzoom-thumbs">
                                ...
                                <a href="{{ url('frontend/images/details-2.jpg') }}">
                                    <img src="{{ url('frontend/images/details-2.jpg') }}" class="xzoom-gallery" width="128"
                                        xpreview="{{ url('frontend/images/details-2.jpg') }}">
                                </a>
                                <a href="{{ url('frontend/images/details-3.jpg') }}">
                                    <img src="{{ url('frontend/images/details-3.jpg') }}" class="xzoom-gallery" width="128"
                                        xpreview="{{ url('frontend/images/details-3.jpg') }}">
                                </a>
                                <a href="{{ url('frontend/images/details-4.jpg') }}">
                                    <img src="{{ url('frontend/images/details-4.jpg') }}" class="xzoom-gallery" width="128"
                                        xpreview="{{ url('frontend/images/details-4.jpg') }}">
                                </a>
                                <a href="{{ url('frontend/images/details-5.jpg') }}">
                                    <img src="{{ url('frontend/images/details-5.jpg') }}" class="xzoom-gallery" width="128"
                            ...
                            <p>
                                ...
                                separates the
                                island and Bali. The interior of Nusa Penida is hilly with a maximum
                    ...
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            <tr>
                                ...
                                <td width="50%" class="text-right">28 Juli, 2020</td>
                            </tr>
                            <tr>
