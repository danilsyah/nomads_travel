                    ...
                    <div class="card card-details mb-3">
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" action="{{ route('checkout-create', $item->id) }}" method="POST">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" name="username" id="username" required
                                    placeholder="Username" />

                                <label class="sr-only" for="nationality">Nationality</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" name="nationality" id="nationality" required
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" name="doe_passport" class="form-control datepicker" id="doe_passport"
                                        placeholder="DOE Passport" required style="width: 150px"/>
                                </div>
